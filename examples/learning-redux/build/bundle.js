...
},{"./SpyUtils":2,"./TestUtils":3,"./assert":4,"is-equal":15,"is-regex":18}],2:[function(require,module,exports){
'use strict';
...
},{"is-equal":15,"is-regex":18}],4:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"object-inspect":21}],5:[function(require,module,exports){
'use strict';
...
},{"is-symbol":20}],15:[function(require,module,exports){
'use strict';
...
},{"./getCollectionsForEach":13,"./getSymbolIterator":14,"has":8,"is-arrow-function":9,"is-boolean-object":10,"is-callable":11,"is-date-object":12,"is-generator-function":16,"is-number-object":17,"is-regex":18,"is-string":19,"is-symbol":20}],16:[function(require,module,exports){
'use strict';
...
var testInitialState = function testInitialState() {
  var newTweet = {};
  (0, _expect2.default)(tweets(undefined, {})).toEqual(newTweet);
};

var testHeartTweet = function testHeartTweet() {
  var currentTweet = { text: "pio pio pio", id: 1, heartCount: 2 };
  var newTweet = { text: "pio pio pio", id: 1, heartCount: 3 };
  var action = { type: 'HEART' };

  (0, _expect2.default)(tweets(currentTweet, action)).toEqual(newTweet);
};
